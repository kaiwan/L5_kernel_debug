...
#define OURMODNAME   "membugs_kasan"
...
static int __init membugs_kasan_init(void)
{
	char *kp = NULL, *res;
...
static void __exit membugs_kasan_exit(void)
{
	pr_debug("%s: removed\n", OURMODNAME);
}

module_init(membugs_kasan_init);
module_exit(membugs_kasan_exit);
